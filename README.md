...
2. Antes de qualquer outra coisa, criaremos um novo ambiente virtual, usando venv . Isso garantirá que nossa configuração de pacote seja mantida bem isolada de qualquer outro projeto em que estejamos trabalhando.
